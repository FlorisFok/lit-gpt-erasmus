...
def prepare(
    destination_path: Path = Path("data/custom"),
    data_dir: str = "/Users/floris/Documents/gpu_cloud/climate_data",
    ...
    dataset = load_dataset(data_dir, num_proc=num_proc_load_dataset)
