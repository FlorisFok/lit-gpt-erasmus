...
def setup(
    ...
    fabric = L.Fabric(loggers=logger, num_nodes=2, devices=devices, strategy=strategy, precision=precision) # devices=devices, strategy=strategy, precision=precision, 
