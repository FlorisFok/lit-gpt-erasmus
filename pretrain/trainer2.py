...
def setup(
    ...
    fabric = L.Fabric(loggers=logger, devices=devices, strategy=strategy, precision=precision, gradient_clip_val=1.0) # devices=devices, strategy=strategy, precision=precision, 
