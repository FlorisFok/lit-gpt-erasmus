...
def setup(
    ...
    fabric = L.Fabric(loggers=logger, devices=devices, strategy=strategy, precision=precision, grad_clip=1.0) # devices=devices, strategy=strategy, precision=precision, 
